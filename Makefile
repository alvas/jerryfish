...
INCLUDES = -I/usr/include -I/usr/local/include;./json11;$(mkfile_path)
...
client: json11.o
	$(CC) $(DFLAGS) $(INCLUDE) client.cpp json11.o -o client

client2.o:
	$(CC) $(CFLAGS) client2.cpp

client2_app: client2.o
	$(CC) $(DFLAGS) $(INCLUDE) client2_app.cpp client2.o -o client2

server: 
	$(CC) $(DFLAGS) $(INCLUDE) server.cpp json11.o process.o -o server

server2.o: process.o
	$(CC) $(CFLAGS) $(INCLUDE) server2.cpp

server2_app: server2.o
	$(CC) $(DFLAGS) $(INCLUDE) server2_app.cpp server2.o json11.o process.o task.o task_type.o buffer.o cache_buffer.o -o server2

test1: server2.o client2.o
	$(CC) $(DFLAGS) $(UNIT_TEST1) $(INCLUDE) test/test1.cpp server2.o client2.o json11.o process.o task.o task_type.o buffer.o cache_buffer.o -o test1; ./test1
